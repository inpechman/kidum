					...
					array(
					   ...
					   "params" => array(
                           ...
                           array(
                               "type" => "dropdown",
                               "class" => "",
                               "heading" => __("Separator Orientation", "ultimate_vc"),
                               "param_name" => "spacer_orientation",
                               "value" => array(
                                   __("Horizontal","ultimate_vc")		=>	"horizontal",
                                   __("Vertical","ultimate_vc")	=>	"vertical"
                               ),
                           ...
                           array(
                               ...
                               "value" => array(
                                   ...
                                   __("Bottom","ultimate_vc")	=>	"bottom",
                                   __("Top & Bottom","ultimate_vc")		=>	"top_and_bottom",
                               ),
		...
		function ultimate_headings_shortcode($atts, $content = null){
			...
			$output = '<div id="'.$id.'" class="uvc-heading '.$id.' '.$uid.' '.$el_class.'" data-hspacer="'.$spacer.'" '.$data.' data-halign="'.$alignment.'" style="text-align:'.$alignment.'">';
				...
				if($spacer_position == 'bottom')
					$output .= $this->ultimate_heading_spacer($wrapper_class, $wrapper_style, $icon_inline);*/
                if($spacer_position == 'top' || $spacer_position == 'top_and_bottom'){
                    if ($spacer_position == "vertical") $output .= '<div class="uvc-heading-spacer divider-vertical '.$wrapper_class.'" style="'.$wrapper_style.'">'.$icon_inline.'</div>';
                    else $output .= $this->ultimate_heading_spacer($wrapper_class, $wrapper_style, $icon_inline);
                }
                if($main_heading != '')
                    $output .= '<div class="uvc-main-heading ult-responsive" '.$main_heading_responsive.'><'.$heading_tag.' style="'.$main_heading_style_inline.'">'.$main_heading.'</'.$heading_tag.'></div>';
                if($spacer_position == 'middle'){
                ...
                if($content != '')
                    $output .= '<div class="uvc-sub-heading ult-responsive" '.$sub_heading_responsive.' style="'.$sub_heading_style_inline.'">'.do_shortcode($content).'</div>';
                if($spacer_position == 'bottom' || $spacer_position == 'top_and_bottom'){
                    if ($spacer_position == "vertical") $output .= '<div class="uvc-heading-spacer divider-vertical '.$wrapper_class.'" style="'.$wrapper_style.'">'.$icon_inline.'</div>';
                    else $output .= $this->ultimate_heading_spacer($wrapper_class, $wrapper_style, $icon_inline);
                }
			$output .= '</div>';
