        ...
        jQuery( ".ult_dual_button" ).each(function( index ) {
             ...
             if(response=='undefined' || response==''){
                ...
                { 
                   ...
                   style.type = 'text/css';
                    style.innerHTML = "@media(min-width:300px) and (max-width:450px) {"+"#"+id+".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper { margin: 0px;float: none;position: relative}.ult_main_dualbtn { display: inline-block}.ult_dualbutton-wrapper { display: block }"+"#"+id+".ult_dual_button .middle-text {top: 100%;right: 50%}"+"#"+id+".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:first-child .ult_ivan_button { border-bottom-right-radius: 0; border-bottom-left-radius: 0; border-top-right-radius: inherit; border-bottom: 0px;}"+"#"+id+".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:last-child .ult_ivan_button { border-top-left-radius: 0;border-top-right-radius: 0}}@media(min-width:450px) and (max-width:765px) {"+"#"+id+".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper { float: left; position: relative}.ult_dual1 {     border-right: none } .ult_dualbutton-wrapper {display: block}"+"#"+id+".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:first-child .ult_ivan_button { border-top-right-radius: 0;  border-bottom-right-radius: 0}"+"#"+id+".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:last-child .ult_ivan_button { border-top-left-radius: 0;  border-bottom-left-radius: 0  }}@media(min-width:765px) and (max-width:970px) { "+"#"+id+".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper { margin: -4px; float: none; position: relative }.ult_dualbutton-wrapper { display: block} "+"#"+id+".ult_dual_button .middle-text { top: 100%; right: 50% }"+"#"+id+".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:first-child .ult_ivan_button { border-bottom-right-radius: 0; border-bottom-left-radius: 0; border-top-right-radius: inherit }"+"#"+id+".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:last-child .ult_ivan_button {     border-top-left-radius: 0;   border-top-right-radius: 0  }}@media(min-width:970px){ "+"#"+id+".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:first-child .ult_ivan_button { border-top-right-radius: 0; border-bottom-right-radius: 0}"+"#"+id+".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:last-child .ult_ivan_button { border-top-left-radius: 0; border-bottom-left-radius: 0 }"+"#"+id+".ult_dual_button .ult_dual1 { border-right: none}}";
