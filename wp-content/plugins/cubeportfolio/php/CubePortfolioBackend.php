...
class CubePortfolioBackend {
    ...
    public function create_home_page() {
        ...
        if (isset( $_GET['page'] ) && $_GET['page'] === 'cubeportfolio' ){
			global $wpdb;
			$portfoliotype = get_option("yunik_portfolio_permalink") ? get_option("yunik_portfolio_permalink") : "portfolio";
    ...
    public function register_assets() {
        // CUBEPORTFOLIO
         ...
         wp_register_style( 'cubeportfolio-jquery-css', CUBEPORTFOLIO_URL . 'public/css/main.min-1.13.1.css', false, CUBEPORTFOLIO_VERSION, 'all' );

        
         wp_register_script( 'cubeportfolio-jquery-js', CUBEPORTFOLIO_URL . 'public/js/main.min-1.13.1.js', array('jquery'), CUBEPORTFOLIO_VERSION, true );

        // ADMIN
        
         wp_register_style( 'cubeportfolio-admin-css', CUBEPORTFOLIO_URL . 'admin/css/main.min-1.13.1.css', false, CUBEPORTFOLIO_VERSION, 'all' );

        
         wp_register_script( 'cubeportfolio-admin-js', CUBEPORTFOLIO_URL . 'admin/js/main.min-1.13.1.js', array('jquery', 'jquery-ui-draggable', 'jquery-ui-sortable'), CUBEPORTFOLIO_VERSION, true );
