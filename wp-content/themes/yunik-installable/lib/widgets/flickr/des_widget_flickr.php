...
class Flickr_Widget extends WP_Widget {
	function Flickr_Widget() {
		$widget_ops = array('classname' => 'flickr_widget', 'description' => __('Show your flickr photos on your site.','yunik'));
...
?>  
       ...
       <p><label for="<?php echo $this->get_field_id('flickrid'); ?>">&#8212; <?php _e('Flickr ID','yunik'); ?> &#8212;<input class="widefat" id="<?php echo $this->get_field_id('flickrid'); ?>" name="<?php echo $this->get_field_name('flickrid'); ?>" type="text" value="<?php echo $flickrid; ?>" /></label></p>
       <p><label for="<?php echo $this->get_field_id('nphotos'); ?>">&#8212; <?php _e('Number Photos to show','yunik'); ?> &#8212;<input class="widefat" id="<?php echo $this->get_field_id('nphotos'); ?>" name="<?php echo $this->get_field_name('nphotos'); ?>" type="text" value="<?php echo $nphotos; ?>" /><br><span class="flickr-stuff">If 0 will show 20 photos.</span></label></p>
       <p><label for="<?php echo $this->get_field_id('linkprofile'); ?>">&#8212; <?php _e('Link to Profile','yunik'); ?> &nbsp;<input id="<?php echo $this->get_field_id('linkprofile'); ?>" name="<?php echo $this->get_field_name('linkprofile'); ?>" type="checkbox" value="yes" <?php if($linkprofile == "yes") echo 'checked'; ?>/><br><span class="flickr-stuff">Title with link to your profile.</span></label></p> 
