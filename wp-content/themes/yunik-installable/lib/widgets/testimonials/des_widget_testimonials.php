...
class Testimonials_Widget extends WP_Widget {
	function Testimonials_Widget() {
		$widget_ops = array('classname' => 'testimonials_widget', 'description' => __('Show your testimonials on your site.','yunik'));
...
?>  
       ...
       <p><label for="<?php echo $this->get_field_id('nshow'); ?>">&#8212; <?php _e('Number Testimonials to show','yunik'); ?> &#8212;<input class="widefat" id="<?php echo $this->get_field_id('nshow'); ?>" name="<?php echo $this->get_field_name('nshow'); ?>" type="text" value="<?php echo $nshow; ?>" /><br><span class="flickr-stuff">If 0 will show all testimonials.</span></label></p>
       <p class="testimonials_autoplay_select"><label for="<?php echo $this->get_field_id('autoplay'); ?>">&#8212; <?php _e('Scroll Items Automatically','yunik'); ?> &nbsp;<input id="<?php echo $this->get_field_id('autoplay'); ?>" name="<?php echo $this->get_field_name('autoplay'); ?>" type="checkbox" value="autoplay" <?php if($autoplay == "autoplay") echo 'checked'; ?>/></label></p>       
	   
	   <p class="testimonials_hidearrows_select"><label for="<?php echo $this->get_field_id('hidearrows'); ?>">&#8212; <?php _e('Hide Navigation Arrows','yunik'); ?> &nbsp;<input id="<?php echo $this->get_field_id('hidearrows'); ?>" name="<?php echo $this->get_field_name('hidearrows'); ?>" type="checkbox" value="hidearrows" <?php if($hidearrows == "hidearrows") echo 'checked'; ?> /></label></p>
		
		<p class="testimonials_hidenav_select"><label for="<?php echo $this->get_field_id('hidenav'); ?>">&#8212; <?php _e('Hide Navigation','yunik'); ?> &nbsp;<input id="<?php echo $this->get_field_id('hidenav'); ?>" name="<?php echo $this->get_field_name('hidenav'); ?>" type="checkbox" value="hidenav" <?php if($hidenav == "hidenav") echo 'checked'; ?> /></label></p>

       <p><label for="<?php echo $this->get_field_id('categories'); ?>">&#8212; <?php _e('Categories','yunik'); ?> &#8212;</label><input style="display:none;" class="widefat" id="<?php echo $this->get_field_id('categories'); ?>" name="<?php echo $this->get_field_name('categories'); ?>" type="text" value="<?php echo $categories; ?>" /></p>
       ...
       <p><label for="<?php echo $this->get_field_id('hideauthor'); ?>">&#8212; <?php _e('Hide Author','yunik'); ?> &nbsp;<input id="<?php echo $this->get_field_id('hideauthor'); ?>" name="<?php echo $this->get_field_name('hideauthor'); ?>" type="checkbox" value="hideauthor" <?php if($hideauthor == "hideauthor") echo 'checked'; ?>/></p>
       <p><label for="<?php echo $this->get_field_id('hidecompany'); ?>">&#8212; <?php _e('Hide Company','yunik'); ?> &nbsp;<input id="<?php echo $this->get_field_id('hidecompany'); ?>" name="<?php echo $this->get_field_name('hidecompany'); ?>" type="checkbox" value="hidecompany" <?php if($hidecompany == "hidecompany") echo 'checked'; ?>/></label></p>  
