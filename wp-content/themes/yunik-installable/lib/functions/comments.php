		...
		<div class="comment-box">
			...
			<div class="comment-reply" style="margin-left: 100px">
				...
				<div class="comment-date post-info">
					...
					<div class="reply">
						<?php if (!function_exists('icl_object_id')) comment_reply_link(array_merge( $args, array('depth' => $depth, 'reply_text'=> get_option(DESIGNARE_SHORTNAME.'_reply_text')))); else comment_reply_link(array_merge( $args, array('depth' => $depth, 'reply_text'=> __("Reply", "yunik")))); ?>
