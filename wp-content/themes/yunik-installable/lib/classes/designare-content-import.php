...
class Auto_Importer extends WP_Importer
{
	...
	function process_terms() {
		include(ABSPATH.'wp-content/plugins/designare_custom_post_types/designare_custom_post_types.php');
...
function wp_insert_category( $catarr, $wp_error = false ) {
	...
	if ( trim( $catarr['cat_name'] ) == '' ) {
		if ( ! $wp_error ) {
			...
			return new WP_Error( 'cat_name', __( 'You did not enter a category name.', 'yunik' ) );
		}
	}
