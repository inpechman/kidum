...
array(
"type" => "open",
"subtitles"=>array(array("id"=>"general", "name"=>"General"), array("id"=>"projects", "name"=>"Projects"), array("id"=>"blog", "name"=>"Blog"), array("id"=>"comment", "name"=>"Comments"), array("id"=>"search", "name"=>"Search"), array("id"=>"contactform", "name"=>"Contact Form"), array("id"=>"twitter","name"=>"Twitter"))
),
...
array(
	...
	"id" => DESIGNARE_SHORTNAME."_breadcrumbs_home_text",
	"type" => "text",
	"std" => "Home"
),
...
array(
"name" => "Next Project",
"id" => DESIGNARE_SHORTNAME."_next_single_proj",
"type" => "text",
"std" => "Next Project"
),
...
"id" => DESIGNARE_SHORTNAME."_prev_single_proj",
"type" => "text",
...
"id" => DESIGNARE_SHORTNAME."_single_previous_text",
"type" => "text",
"std" => "Previous post"
),
...
"id" => DESIGNARE_SHORTNAME."_single_next_text",
"type" => "text",
"std" => "Next post"
),
...
"id" => DESIGNARE_SHORTNAME."_next_results",
"type" => "text",
"std" => "Next results"
),
...
"id" => DESIGNARE_SHORTNAME."_previous_results",
"type" => "text",
...
array(
"name" => "Follow us",
"id" => DESIGNARE_SHORTNAME."_twitter_follow_us",
"type" => "text",
...
array(
"name" => "Pre Tweet",
"id" => DESIGNARE_SHORTNAME."_twitter_pre_tweet",
"type" => "text",
