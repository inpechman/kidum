var designarePageOptions={
	...
	init:function(){
		...
		if (jQuery('#yunik_enable_breadcrumbs_value').length){
			jQuery('#yunik_enable_breadcrumbs_value').change(function(){
				if (jQuery(this).val() == "yes"){
					jQuery('#yunik_breadcrumbs_margin_top_noncename').parent().removeClass('optoff').css('display','block');
				} else {
					jQuery('#yunik_breadcrumbs_margin_top_noncename').parent().addClass('optoff').css('display','none');
				}
			}).trigger('change');
		}
		...
		if (jQuery('#yunik_enable_custom_pagetitle_options_value').val() == 'yes'){
			jQuery('#yunik_header_type_value').closest('.option-container').css('display','block');
			showElements(jQuery('#yunik_enable_custom_pagetitle_options_value').closest('.option-container').nextUntil(jQuery('.underconstructionoptions')).removeClass('hiddenoption'), 0);
			jQuery('#yunik_header_type_value').trigger('change');
			jQuery('#yunik_enable_breadcrumbs_value').trigger('change');
		} else {
			hideElements(jQuery('#yunik_enable_custom_pagetitle_options_value').closest('.option-container').nextUntil(jQuery('.underconstructionoptions')).addClass('hiddenoption'), 0);
		}

		jQuery('#yunik_enable_custom_pagetitle_options_value').change(function(){
			if (jQuery('#yunik_enable_custom_pagetitle_options_value').val() == 'yes'){
				jQuery('#yunik_header_type_value').closest('.option-container').css('display','block');
				showElements(jQuery('#yunik_enable_custom_pagetitle_options_value').closest('.option-container').nextUntil(jQuery('.underconstructionoptions')).removeClass('hiddenoption'), 0);
				jQuery('#yunik_header_type_value').trigger('change');
		...
		if (jQuery('#yunik_header_type_value').val() != 'without'){
			if (jQuery('#yunik_hide_pagetitle_value').val() == 'yes'){
				jQuery('#yunik_hide_pagetitle_value').closest('.option-container').nextUntil(jQuery('#yunik_header_text_margin_top_noncename').parent().next()).not('script').css('display','block');
			} else jQuery('#yunik_hide_pagetitle_value').closest('.option-container').nextUntil(jQuery('.underconstructionoptions')).css('display','none');
		}
		jQuery('#yunik_hide_pagetitle_value').change(function(){
			if (jQuery('#yunik_header_type_value').val() != 'without'){
				if (jQuery('#yunik_hide_pagetitle_value').val() == 'yes'){
					jQuery('#yunik_hide_pagetitle_value').closest('.option-container').nextUntil(jQuery('#yunik_header_text_margin_top_noncename').parent().next()).not('script').css('display','block');
				} else jQuery('#yunik_hide_pagetitle_value').closest('.option-container').nextUntil(jQuery('#yunik_header_text_margin_top_noncename').parent().next()).css('display','none');
			}
		});
		
		if (jQuery('#yunik_header_type_value').val() != 'without'){
			if (jQuery('#yunik_hide_sec_pagetitle_value').val() == 'yes'){
				jQuery('#yunik_hide_sec_pagetitle_value').closest('.option-container').nextUntil(jQuery('#yunik_header_text_margin_top_noncename').parent().next()).not('script').css('display','block');
			} else jQuery('#yunik_hide_sec_pagetitle_value').closest('.option-container').nextUntil(jQuery('#yunik_header_text_margin_top_noncename').parent().next()).css('display','none');
		}
		
		jQuery('#yunik_hide_sec_pagetitle_value').change(function(){
			if (jQuery('#yunik_header_type_value').val() != 'without'){
				if (jQuery('#yunik_hide_sec_pagetitle_value').val() == 'yes'){
					jQuery('#yunik_hide_sec_pagetitle_value').closest('.option-container').nextUntil(jQuery('.breadcrumboptions')).not('script').css('display','block');
				} else jQuery('#yunik_hide_sec_pagetitle_value').closest('.option-container').nextUntil(jQuery('.breadcrumboptions')).css('display','none');
			}
		});
		
		jQuery('#yunik_pagetitle_image_overlay_value').change(function(){
			if (jQuery(this).val() == "on"){
				jQuery('#yunik_pagetitle_overlay_type_value').closest('.option-container')
					.add(jQuery('#yunik_pagetitle_overlay_opacity_noncename').closest('.option-container'))
				.css('display','block');
				jQuery('#yunik_pagetitle_overlay_type_value').change();
			} else {
				jQuery('#yunik_pagetitle_overlay_type_value').closest('.option-container').nextUntil(jQuery('#yunik_pagetitle_overlay_opacity_slider').closest('.option-container').next()).andSelf()
					.add(jQuery('#yunik_pagetitle_overlay_pattern_value').closest('.option-container'))
				.css('display','none');
			}
		});
		
		jQuery('#yunik_pagetitle_overlay_type_value').change(function(){
			if (jQuery(this).val() == "color"){
				jQuery('#yunik_pagetitle_overlay_color').closest('.option-container').css('display','block');
				jQuery('#yunik_pagetitle_overlay_pattern_noncename').closest('.option-container').css('display','none');
			} else {
				jQuery('#yunik_pagetitle_overlay_color').closest('.option-container').css('display','none');
				jQuery('#yunik_pagetitle_overlay_pattern_noncename').closest('.option-container').css('display','block');
			}
		});
		
		jQuery('#yunik_header_type_value').change(function(){
			switch (jQuery('#yunik_header_type_value').val()){
				case "without":
					jQuery('#yunik_header_image_noncename').closest('.option-container').nextUntil(jQuery('#yunik_breadcrumbs_margin_top_noncename').closest('.option-container')).add(jQuery('#yunik_breadcrumbs_margin_top_noncename').closest('.option-container')).add(jQuery('#yunik_header_image_noncename').closest('.option-container')).css('display','none');	
				break;
				case "color":
					jQuery('#yunik_header_image_noncename').closest('.option-container')
						.add(jQuery('#yunik_header_pattern_noncename').closest('.option-container'))
						.add(jQuery('#yunik_header_custom_pattern_noncename').closest('.option-container'))
						.add(jQuery('#yunik_banner_slider_value').closest('.option-container'))
					.css('display','none');
					jQuery('#yunik_header_color_noncename').closest('.option-container').add(jQuery('#yunik_hide_sec_pagetitle_value').closest('.option-container')).add(jQuery('#yunik_hide_pagetitle_value').closest('.option-container'))
						.add(jQuery('#yunik_hide_sec_pagetitle_value').closest('.option-container').prev()).add(jQuery('#yunik_hide_pagetitle_value').closest('.option-container').prev())
						.add(jQuery('#yunik_header_text_alignment_noncename').closest('.option-container'))
						.add(jQuery('#yunik_header_height_noncename').closest('.option-container'))
						.add(jQuery('#yunik_header_color_opacity_noncename').closest('.option-container'))
						.add(jQuery('#yunik_page_title_padding_noncename').closest('.option-container'))
						.add(jQuery('.breadcrumboptions').nextUntil(jQuery('.underconstructionoptions')).andSelf())
					.css('display','block');
					
					jQuery('#yunik_pagetitle_image_parallax_value').closest('.option-container').nextUntil(jQuery('#yunik_pagetitle_overlay_opacity_noncename').closest('.option-container').next()).andSelf().css('display','none');
					jQuery('#yunik_pagetitle_image_parallax_value').closest('.option-container').css('display','block');
					jQuery('#yunik_hide_sec_pagetitle_value').add(jQuery('#yunik_hide_pagetitle_value')).add(jQuery('#yunik_enable_breadcrumbs_value')).trigger('change');
				break;
				case "image":
					jQuery('#yunik_header_color_noncename').closest('.option-container')
						.add(jQuery('#yunik_header_pattern_noncename').closest('.option-container'))
						.add(jQuery('#yunik_header_custom_pattern_noncename').closest('.option-container'))
						.add(jQuery('#yunik_banner_slider_value').closest('.option-container'))
						.add(jQuery('#yunik_header_color_opacity_noncename').closest('.option-container'))
					.css('display','none');
					jQuery('#yunik_header_image_noncename').closest('.option-container').add(jQuery('#yunik_hide_sec_pagetitle_value').closest('.option-container')).add(jQuery('#yunik_hide_pagetitle_value').closest('.option-container'))
						.add(jQuery('#yunik_hide_sec_pagetitle_value').closest('.option-container').prev()).add(jQuery('#yunik_hide_pagetitle_value').closest('.option-container').prev())
						.add(jQuery('#yunik_header_text_alignment_noncename').closest('.option-container'))
						.add(jQuery('#yunik_header_height_noncename').closest('.option-container'))
						.add(jQuery('#yunik_page_title_padding_noncename').closest('.option-container'))
					...
					// erererererere
					jQuery('#yunik_pagetitle_image_parallax_value').closest('.option-container').add(jQuery('#yunik_pagetitle_image_overlay_value').closest('.option-container')).css('display','block');
					jQuery('#yunik_pagetitle_image_overlay_value').change();
					
				break;
				case "pattern":
					jQuery('#yunik_header_image_noncename').closest('.option-container')
						.add(jQuery('#yunik_header_color_noncename').closest('.option-container'))
						.add(jQuery('#yunik_banner_slider_value').closest('.option-container'))
						.add(jQuery('#yunik_header_custom_pattern_noncename').closest('.option-container'))
						.add(jQuery('#yunik_header_color_opacity_noncename').closest('.option-container'))
					.css('display','none');
					jQuery('#yunik_header_pattern_noncename').closest('.option-container')
						.add(jQuery('#yunik_hide_sec_pagetitle_value').closest('.option-container')).add(jQuery('#yunik_hide_pagetitle_value').closest('.option-container'))
						.add(jQuery('#yunik_hide_sec_pagetitle_value').closest('.option-container').prev()).add(jQuery('#yunik_hide_pagetitle_value').closest('.option-container').prev())
						.add(jQuery('#yunik_header_text_alignment_noncename').closest('.option-container'))
						.add(jQuery('#yunik_header_height_noncename').closest('.option-container'))
						.add(jQuery('#yunik_page_title_padding_noncename').closest('.option-container'))
				...
				case "custom_pattern":
					jQuery('#yunik_header_image_noncename').closest('.option-container')
						...
						.add(jQuery('#yunik_header_color_opacity_noncename').closest('.option-container'))
					.css('display','none');
					jQuery('#yunik_header_custom_pattern_noncename').closest('.option-container')
						.add(jQuery('#yunik_hide_sec_pagetitle_value').closest('.option-container')).add(jQuery('#yunik_hide_pagetitle_value').closest('.option-container'))
						.add(jQuery('#yunik_hide_sec_pagetitle_value').closest('.option-container').prev()).add(jQuery('#yunik_hide_pagetitle_value').closest('.option-container').prev())
						.add(jQuery('#yunik_header_text_alignment_noncename').closest('.option-container'))
						.add(jQuery('#yunik_header_height_noncename').closest('.option-container'))
				...
				case "banner":
					...
					jQuery('#yunik_banner_slider_value').closest('.option-container').add(jQuery('#yunik_hide_sec_pagetitle_value').closest('.option-container')).add(jQuery('#yunik_hide_pagetitle_value').closest('.option-container'))
						.add(jQuery('#yunik_hide_sec_pagetitle_value').closest('.option-container').prev()).add(jQuery('#yunik_hide_pagetitle_value').closest('.option-container').prev())
						.add(jQuery('#yunik_header_text_alignment_noncename').closest('.option-container'))
						.add(jQuery('#yunik_header_height_noncename').closest('.option-container'))
						.add(jQuery('.breadcrumboptions').nextUntil(jQuery('.underconstructionoptions')).andSelf())
		...
		if (jQuery('#homeStyle_value').length){
			...
			jQuery('.homepage_styles_thumbs').click(function(){
				...
				designarePageOptions.updateHomeStyleOptions();
			});
		}
		
		if (jQuery('#videoSource_value').length){
			jQuery('#videoMediaLibrary_noncename').closest('.option-container').css({'border':'none','padding-left':'0px'}).appendTo(jQuery('#videoSource_value').closest('.option-container'));
		...
		if (jQuery('#audioSource_value').length){
			jQuery('#audioCode_noncename').parent().add(jQuery('#audioMediaLibrary_noncename').parent()).css({'border':'none','padding-left':'0px'}).appendTo(jQuery('#audioSource_noncename').parent());
		...
		if (jQuery('#homeVideoSource_value').length){
			designarePageOptions.updateVideoSourceOptions();
			jQuery('#homeVideoSource_value').change(function(){ designarePageOptions.updateVideoSourceOptions(); });
		}
		
		/* logo type */
		if (jQuery('#introLogo_value').length){
			designarePageOptions.updateLogoTypeOptions();
			jQuery('#introLogo_value').change(function(){ designarePageOptions.updateLogoTypeOptions(); });
		}
		...
		if (jQuery('textarea[name=introCaptionsList_value]').length){
			...
			jQuery(document).on('keypress', '.captions_list_item input', function(e){
				if ( e.which == 13 ) {
					...
					designarePageOptions.updateCaptionsList();
				}
			});
			...
			if (captions.length > 0){
				for (i=0; i<captions.length; i++){
					if (captions[i] != ""){
						jQuery('.captions_list_container').append('<div class="captions_list_item"><div class="saved_text" onclick="jQuery(this).siblings(\'input\').css(\'display\',\'block\').focus();">'+captions[i]+'</div><input type="text" value="'+captions[i]+'" onblur="jQuery(this).css(\'display\',\'none\').siblings(\'.saved_text\').html(jQuery(this).val());designarePageOptions.updateCaptionsList();"/><a title="Delete Image" class="removeImage" style="position:absolute;top:5px;right:5px;width:26px;height:23px;background:url('+jQuery('.temppath').html()+'/img/admin-delete-icon.png) no-repeat;cursor:pointer;" onclick="jQuery(this).parent().remove();designarePageOptions.updateCaptionsList();" ></a></div>');
					}
				}	
			}
			...
			jQuery('.add-new-caption').click(function(){
				jQuery('.captions_list_container').append('<div class="captions_list_item"><div class="saved_text" onclick="jQuery(this).siblings(\'input\').css(\'display\',\'block\').focus();"></div><input type="text" value="Your text here." onblur="jQuery(this).css(\'display\',\'none\').siblings(\'.saved_text\').html(jQuery(this).val());designarePageOptions.updateCaptionsList();"/><a title="Delete Image" class="removeImage" style="position:absolute;top:5px;right:5px;width:26px;height:23px;background:url('+jQuery('.temppath').html()+'/img/admin-delete-icon.png) no-repeat;cursor:pointer;" onclick="jQuery(this).parent().remove();designarePageOptions.updateCaptionsList();" ></a></div>').find('.captions_list_item input').last().css('display','block').focus();
			});
			...
			designarePageOptions.updateCaptionsOptions();
			jQuery('#introCaptionsEnable_value').change(function(){ designarePageOptions.updateCaptionsOptions(); });
		}
		
		if (jQuery('#introContinueType_value').length){
			designarePageOptions.updateContinueButtonTypeOptions();
			jQuery('#introContinueType_value').change(function(){ designarePageOptions.updateContinueButtonTypeOptions(); });
		}
		
		if (jQuery('#introContinueEnable_value').length){
			designarePageOptions.updateContinueButtonOptions();
			jQuery('#introContinueEnable_value').change(function(){ designarePageOptions.updateContinueButtonOptions(); });
		}
		...
		if (jQuery('#post_type').length > 0 && jQuery('#post_type').val() == "page"){
			...
			jQuery('#pageparentdiv.postbox .inside').css('display','inline-block').append(jQuery('.des_sidebars_available'));
			jQuery('#pageparentdiv.postbox .inside .des_layouts').each(function(){
				...
				if (jQuery('#pageparentdiv.postbox .inside .des_layouts.selected').attr('title') === "none"){
					jQuery('#pageparentdiv.postbox .inside .des_sidebars_available').css('display','none');
				} else {
					jQuery('#pageparentdiv.postbox .inside .des_sidebars_available').css('display','block');
				}
		...
		designarePageOptions.updateHomeStyleOptions();
		jQuery('#page_template').add(jQuery('#yunik_header_type_value')).trigger('change');
	},
	...
	updatePortfolioTypeOpts: function(){
		switch(jQuery('#portfolioType_value').val()){
			case "image":
				...
				designarePageOptions.updateCustomFlex();
			break;
			case "video":
...
function togglePageOptions(action){
	switch (action){
		case "show":
			...
			jQuery('#yunik_enable_custom_pagetitle_options_value').trigger('change');
			break;
		case "hide":
