...
function wp_pagenavi($before = '', $after = '') {
	...
	if (!is_single()) {
		...
		if($max_page > 1 || intval($pagenavi_options['always_show']) == 1) {
			...
			$pages_text = __("Page ","yunik") . $paged . __(" of ","yunik") . $max_page;
			...
			switch(intval($pagenavi_options['style'])) {
				...
				case 2:
					...
					echo '<label class="gotopagedd" for="pagedd">'. __('Go to page','yunik') .'</label>';
...
function pagenavi_init() {
	...
	$pagenavi_options['pages_text'] = __('Page _CURRENT_PAGE_ of _TOTAL_PAGES_','yunik');
	$pagenavi_options['current_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['page_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['first_text'] = __('&laquo;','yunik');
	$pagenavi_options['last_text'] = __('&raquo;','yunik');
	$pagenavi_options['next_text'] = __('&raquo;','yunik');
	$pagenavi_options['prev_text'] = __('&laquo;','yunik');
	$pagenavi_options['dotright_text'] = __('...','yunik');
	$pagenavi_options['dotleft_text'] = __('...','yunik');
